...
# from ..app import TimeSeriesManager
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.time_series_manager"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.time_series_manager.tests.tests"

        To run tests in the TimeSeriesManagerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.time_series_manager.tests.tests.TimeSeriesManagerTestCase"

        To run only the test_if_tethys_platform_is_great function in the TimeSeriesManagerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.time_series_manager.tests.tests.TimeSeriesManagerTestCase.test_if_tethys_platform_is_great"
...
class TimeSeriesManagerTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(TimeSeriesManager)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(TimeSeriesManager)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/time-series-manager/')  # The final '/' is essential for all pages/controllers
